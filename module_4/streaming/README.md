...
```bash
#$(aws ecr get-login --no-include-email)   DEPRECATED
aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 585315266445.dkr.ecr.us-east-1.amazonaws.com
...
REMOTE_URI="585315266445.dkr.ecr.us-east-1.amazonaws.com/duration-model"
REMOTE_TAG="v1"
